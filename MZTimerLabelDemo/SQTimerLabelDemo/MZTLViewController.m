...
- (void)viewDidLoad
{
    ...
    /*******************************************
     * ------Example 1-----
     * Use timer on existing and styled SQTimerLabel from Storyboard/Xib, simplest usage.
     * REMARKS:initialize without TimerType using SQTimerLabelTypeStopWatch as default
     ********************************************/
    [_lblTimerExample1 start];
    
    /*******************************************
     * ------Example 2-----
     * Using SQTimerLabel instance only and set differene time format
     ********************************************/
    SQTimerLabel *timer2 = [[SQTimerLabel alloc] initWithFrame:CGRectMake(0, 155, self.view.frame.size.width, 40)];
    timer2.timerType = SQTimerLabelTypeStopWatch;
...
//     * Count Down Timer
//     ********************************************/
//    timerExample3 = [[SQTimerLabel alloc] initWithLabel:_lblTimerExample3 andTimerType:SQTimerLabelTypeTimer];
...
//     ********************************************/
//    timerExample4 = [[SQTimerLabel alloc] initWithLabel:_lblTimerExample4 andTimerType:SQTimerLabelTypeStopWatch];
...
//     ********************************************/
//    timerExample5 = [[SQTimerLabel alloc] initWithLabel:_lblTimerExample5 andTimerType:SQTimerLabelTypeTimer];
...
//     ********************************************/
//    timerExample6 = [[SQTimerLabel alloc] initWithLabel:_lblTimerExample6 andTimerType:SQTimerLabelTypeTimer];
...
//     ********************************************/
//    timerExample7 = [[SQTimerLabel alloc] initWithLabel:_lblTimerExample7 andTimerType:SQTimerLabelTypeTimer];
...
//     ********************************************/
//    timerExample8 = [[SQTimerLabel alloc] initWithLabel:_lblTimerExample8];
...
//     ********************************************/
//
//    timerExample9 = [[SQTimerLabel alloc] initWithLabel:_lblTimerExample9 andTimerType:SQTimerLabelTypeTimer];
...
//     ********************************************/
//
//    timerExample10 = [[SQTimerLabel alloc] initWithLabel:_lblTimerExample10 andTimerType:SQTimerLabelTypeStopWatch];
...
//     ********************************************/
//
//    timerExample11 = [[SQTimerLabel alloc] initWithLabel:_lblTimerExample11 andTimerType:SQTimerLabelTypeTimer];
...
//     * As SQTimerLabel uses NSDateFormatter to convert the time difference to String, there is no format string support
...
//     ********************************************/
//
//    timerExample12 = [[SQTimerLabel alloc] initWithLabel:_lblTimerExample12 andTimerType:SQTimerLabelTypeStopWatch];
...
//     ********************************************/
//
//    timerExample13 = [[SQTimerLabel alloc] initWithLabel:_lblTimerExample13 andTimerType:SQTimerLabelTypeTimer];
...
/*****THIS IS SQTimerLabel DELEGATE Method*****/
